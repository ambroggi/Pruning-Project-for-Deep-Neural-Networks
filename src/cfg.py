...
class ConfigObject():
    ...
    def __init__(self):
        ...
        self.parameters: dict[str, list[any, str, str]] = {
            ...
            "MaxSamples": [-1, "Maximum number of samples in the data, 0 is no limit. Note that the data is random split", "int"],
            ...
            "WeightPrunePercent": ["0.99, 0.99, 0.99, 1", "Percent of weights to prune down to for each layer", "strl"],
