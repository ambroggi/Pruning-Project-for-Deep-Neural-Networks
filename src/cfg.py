...
class ConfigObject():
    ...
    def __init__(self):
        ...
        self.parameters: dict[str, list[any, str, str]] = {
            ...
            "AlphaForADMM": [1.0, "Alpha value for ADMM model", "float"],
            "RhoForADMM": [1.0, "Rho value for ADMM model", "float"],
            ...
            "WeightPrunePercent": ["0.9, 0.5, 1, 1", "Percent of weights to prune down to for each layer", "strl"],
